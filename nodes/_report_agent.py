...
def run_report_agent(pipeline_result, *, api_key, model_name=GEMINI_REPORT_MODEL):
    ...
    patient_snapshot_defaults = report_packet.get("patient_snapshot") or {}
    try:
        ...
        report = normalize_final_report(report, patient_snapshot_defaults=patient_snapshot_defaults)
